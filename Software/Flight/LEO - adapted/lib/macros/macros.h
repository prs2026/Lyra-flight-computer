...
#define MSC_FLASH_SIZE (4 * 1024 * 1024)
#define MSC_BLOCK_COUNT (MSC_FLASH_SIZE / 512)
#define MSC_FLASH_OFFSET (PICO_FLASH_SIZE_BYTES - MSC_FLASH_SIZE)
#define FLASH_LOG_SIZE (FLASH_FILESYSTEM_SIZE - MSC_FLASH_SIZE)
#define FLASH_TARGET_OFFSET (MSC_FLASH_OFFSET - FLASH_LOG_SIZE)
