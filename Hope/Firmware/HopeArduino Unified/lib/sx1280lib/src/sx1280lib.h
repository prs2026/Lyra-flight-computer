...
const uint32_t Frequency = 2.445000000*1e9;          //frequency of transmissions
const uint32_t RangingFrequency = 2.450000000*1e9;   //frequency of ranging
...
const int8_t RangingTXPower = 13;                //Transmit power used
